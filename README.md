...
In atomic units (i.e., distances of bohr), the following describes a cross-section of a 3p orbital of the hydrogen atom:
...
Create an image depicting this 2D cross-section, with a size of at least `512 x 512` pixels.
